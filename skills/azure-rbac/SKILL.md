...
| Security | L65-L130 | Azure RBAC roles, permissions, ABAC conditions, custom roles, deny assignments, PIM, and policy controls for securing access to Azure resources and managing privileged operations |
