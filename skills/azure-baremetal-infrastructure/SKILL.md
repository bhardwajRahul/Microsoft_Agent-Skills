...
This skill provides expert guidance for Azure Baremetal Infrastructure development. It combines local quick-reference content with remote documentation fetching capabilities.
...
|----------|-------|-------------|
| Decision Making | L25-L28 | Guidance on selecting NC2 on Azure bare metal regions and SKUs, including capacity, performance, and placement considerations for different workload needs. |
