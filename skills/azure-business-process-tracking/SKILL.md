...
This skill provides expert guidance for Azure Business Process Tracking development. It combines local quick-reference content with remote documentation fetching capabilities.
...
|----------|-------|-------------|
| Integrations & Coding Patterns | L26-L30 | Design patterns for mapping business process stages to Azure Logic Apps workflows, including correlating runs, tracking state, and integrating process telemetry. |
| Deployment | L31-L35 | How to deploy business processes and tracking profiles to Azure and set up CI/CD pipelines (build, release, automation) for Business Process Tracking. |
