...
This skill provides expert guidance for Sql Server Stretch Database development. It combines local quick-reference content with remote documentation fetching capabilities.
