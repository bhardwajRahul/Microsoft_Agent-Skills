...
|----------|-------|-------------|
| Limits & Quotas | L27-L31 | Resiliency feature support matrix, supported/unsupported scenarios, and limitations for using Azure Business Continuity Center across services and regions. |
| Security | L32-L37 | Guidance on security levels and controls in Azure Resiliency, and how to review, configure, and improve the security posture of your resiliency and continuity setup. |
| Configuration | L38-L44 | Configuring Azure Backup/Recovery Services vaults and policies, including creating, managing, and lifecycle operations for backup and replication protection settings. |
