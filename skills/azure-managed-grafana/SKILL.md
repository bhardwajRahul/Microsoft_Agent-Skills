...
| Decision Making | L37-L44 | Guidance on reliability/HA options, choosing and activating Enterprise plans, migrating tiers or to Azure Monitor, and upgrading workspaces between Grafana versions. |
...
| Security | L51-L62 | Security, auth, and access control for Managed Grafana: encryption, identity and permissions, Entra team sync, private endpoints, Azure Monitor access, and hardening best practices. |
| Configuration | L63-L72 | Configuring Managed Grafana workspaces, data sources, plugins, diagnostics, service accounts/tokens, and SMTP email alerts for monitoring and alerting setup. |
| Integrations & Coding Patterns | L73-L81 | Integrating Azure Managed Grafana with Prometheus, Azure Monitor, AKS, Azure Data Explorer, and Azure AI Foundry, including auth setup, private endpoints, and monitoring dashboard patterns. |
| Deployment | L82-L88 | Guides for deploying Managed Grafana: setting deterministic outbound IPs, enabling zone redundancy, migrating from existing Grafana, and wiring Azure Monitor alerts into dashboards. |
