...
This skill provides expert guidance for Azure Network Function Manager development. It combines local quick-reference content with remote documentation fetching capabilities.
