...
|----------|-------|-------------|
| Troubleshooting | L34-L45 | Diagnosing and fixing Foundry/Azure OpenAI issues: deployments, monitors, private endpoints, fine-tuning, webhooks, portal errors, and monitoring agent service metrics. |
| Best Practices | L46-L60 | Best practices for Azure OpenAI/Foundry: prompt and system message design, reasoning models, embeddings/On Your Data, performance/latency, safety, and high availability/disaster recovery. |
| Decision Making | L61-L91 | Guidance for choosing Foundry/Azure OpenAI models, hubs, deployments, and SDKs, plus planning cost, capacity, HA/DR, migrations, and handling model deprecation or upgrades. |
| Architecture & Design Patterns | L92-L97 | Designing resilient Azure OpenAI/Foundry Agent architectures, including disaster recovery, business continuity, failover strategies, and BCDR best practices for production deployments |
| Limits & Quotas | L98-L113 | Quotas, rate limits, scaling, and cost controls for Azure OpenAI and Foundry (agents, models, batch jobs, prompt caching, fine-tuning), plus how to view, manage, and request increases. |
...
| Configuration | L158-L203 | Configuring and managing Azure AI/Foundry and Azure OpenAI: networking, storage, security, logging/monitoring, evaluations, fine-tuning, content filters, tools, and project/agent connections. |
| Integrations & Coding Patterns | L204-L300 | Patterns and code to integrate Azure/OpenAI/Foundry models and agents with tools, data sources, RAG, function calling, observability, and external apps via SDKs, REST, and frameworks. |
| Deployment | L301-L322 | Deploying and managing Foundry models, hubs, and projects (Bicep, CLI, Terraform, SDK), serverless endpoints, fine-tuned models, CI/CD evaluations, and regional/feature availability. |
...
| Call Azure OpenAI image generation and editing APIs | https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/dall-e?view=foundry-classic |
