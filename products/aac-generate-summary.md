...
|---|---------|-------|------------|-----|---------|---------|--------|
| 1 | Azure Architecture | 365 | 307 | 0 | 2 | 0 | ✓ |

### Totals

- **Products Processed**: 1 success, 0 failed
- **Total Pages**: 365
- **Total Classified**: 307
- **Total New Pages**: 0
...
| migration-guides | 27 |
| reference-architectures | 41 |
| solution-ideas | 21 |
| technology-choices | 35 |
...
|---|--------|------|------|---------|----------|---------|
| 1 | active | azure-architecture | Azure Architecture | https://learn.microsoft.com/en-us/azure/architecture/toc.json | 0 | 0 |
